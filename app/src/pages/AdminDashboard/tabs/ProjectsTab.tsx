...
interface ProjectsTabProps {
  ...
  handleEditGitHubSettings: (project: Project, e: React.MouseEvent) => void;
  handleSendGitHubInvites: (project: Project, e: React.MouseEvent) => void;
  handleOpenProjectMembers: (project: Project, e: React.MouseEvent) => void;
}
