...
export const DUE_DATE_CALENDAR_CLASS_NAMES = {
  ...
  nav_button: 'text-white hover:bg-[rgba(255,255,255,0.08)] rounded p-1',
  ...
  day_selected:
    'bg-brand text-black hover:bg-brand hover:text-black focus:bg-brand focus:text-black',
  day_today: 'bg-[rgba(91,155,230,0.2)] text-white',
  day_outside:
