  ...
  return (
    <div className="flex items-center justify-between px-[18px] py-3 border-b border-white/[0.08] flex-none">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-center gap-1.5 h-[30px] px-[11px] border border-white/[0.08] rounded-md text-[11px] text-[#a3a3a3]">
          <span className="text-[#737373]">Working hours</span>
          <span className="text-[#f5f5f5] font-medium">
            {formatClock(cfg.startHour)} – {formatClock(cfg.endHour)}
          </span>
        </div>
