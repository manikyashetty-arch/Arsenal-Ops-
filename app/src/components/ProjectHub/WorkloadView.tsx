            ...
            <CardContent>
                {sortedData.length === 0 ? (
                    <div className="text-center py-12">
                        <p className="text-[#64748B]">No workload data available</p>
                    </div>
                ) : (
                        ...
                        {sortedData.map((developer) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="bg-[#0A0A14] rounded-lg p-4 border border-[rgba(244,246,255,0.06)] hover:border-[rgba(244,246,255,0.1)] transition-colors cursor-pointer"
                                    onClick={() => onDeveloperClick?.(developer.developer_id)}
                                >
                                    <div className="flex items-center gap-3 mb-4">
                                        <Avatar className="w-10 h-10 bg-[#6366F1]">
                                            <AvatarFallback className="bg-[#6366F1] text-white text-sm font-medium">
                                                {getInitials(developer.developer_name)}
                                            </AvatarFallback>
                                        </Avatar>
                                        <div className="flex-1">
                                            <h3 className="text-white font-medium">{developer.developer_name}</h3>
                                            <p className="text-[#64748B] text-sm">{developer.total_items} items</p>
                                        </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="h-2 bg-[rgba(244,246,255,0.06)] rounded-full overflow-hidden">
                                            <div
                                    ...
                                    <div className="grid grid-cols-3 gap-2 mb-4">
                                        <div className="text-center p-2 rounded bg-[rgba(244,246,255,0.02)]">
                                            <div className="flex items-center justify-center gap-1 mb-1">
                                                <CheckCircle2 className="w-3 h-3 text-[#10B981]" />
                                            </div>
                                            <p className="text-white font-medium">{developer.completed_items}</p>
                                            <p className="text-[#64748B] text-xs">Done</p>
                                        </div>
                                        <div className="text-center p-2 rounded bg-[rgba(244,246,255,0.02)]">
                                            <div className="flex items-center justify-center gap-1 mb-1">
                                        ...
                                        <div className="text-center p-2 rounded bg-[rgba(244,246,255,0.02)]">
                                            ...
                                            <p className="text-[#64748B] text-xs">Overdue</p>
                                        </div>
                                    </div>
                ...
                {/* Legend */}
                <div className="flex items-center gap-6 mt-6 pt-4 border-t border-[rgba(244,246,255,0.06)]">
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-green-500" />
                        <span className="text-[#64748B] text-sm">Under 80%</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-yellow-500" />
                        <span className="text-[#64748B] text-sm">80-100%</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-red-500" />
                        <span className="text-[#64748B] text-sm">Over capacity</span>
                    </div>
                </div>
            </CardContent>
        </Card>
