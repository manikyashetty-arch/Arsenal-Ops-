...
export default function PMView({ projectId, isAdmin = false, sprints = [] }: PMViewProps) {
    const { can } = useAuth();
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {sprint.start_date && sprint.end_date && (
                                                    <p className="text-xs text-[#737373]">
                                                        📅 {parseLocalDate(sprint.start_date).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })} – {parseLocalDate(sprint.end_date).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}
                                                    </p>
                                                )}
                                            </div>
