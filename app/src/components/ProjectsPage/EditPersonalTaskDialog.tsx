...
interface EditPersonalTaskDialogProps {
    ...
    setForm: (next: EditPersonalTaskForm | ((prev: EditPersonalTaskForm) => EditPersonalTaskForm)) => void;
                            ...
                            <Popover open={showCalendar} onOpenChange={setShowCalendar}>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        ...
                                        {form.due_date ? parseLocalDate(form.due_date)?.toLocaleDateString() : 'Pick a date'}
                                    </Button>
                                </PopoverTrigger>
