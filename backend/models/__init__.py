...
__all__ = [
    ...
    "Sprint", "Comment", "TimeEntry", "TaskDependency", "ProjectGoal", "ProjectMilestone", "ActivityLog", "ProjectFile", "ProjectLink", "CustomRestriction", "PersonalTask", "WorkItemAssignmentHistory"
]
